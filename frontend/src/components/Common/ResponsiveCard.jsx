...
const ResponsiveCard = ({ children, className = '', hover = true, delay = 0 }) => {
  return (
    <div 
...
export const CardHeader = ({ title, subtitle, icon: Icon, action, titleColor = "text-gray-900 " }) => (
  <div className="flex items-start justify-between mb-4 gap-4">
    <div className="flex-1 min-w-0"> {/* min-w-0 ensures text truncation works */}
      {title && (
        <h3 className={`text-lg font-bold truncate flex items-center gap-2 ${titleColor}`}>
